# AquamanSite
Movie Trailer framework using Atomic Design process (Winter 2019).
[Example framework](https://github.com/ewuweblab/movie-trailer-framework/blob/master/README.md) 
